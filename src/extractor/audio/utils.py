...
def get_all_audio_methods(ignore_methods: Sequence[str] = ()):
    for feature_set, feature_level in product(opensmile.FeatureSet, opensmile.FeatureLevel):
        ...
        if feature_set == opensmile.FeatureSet.ComParE_2016 and feature_level == opensmile.FeatureLevel.Functionals:
            feature_size = 6373
            ...
            feature_size = 25
        elif feature_set == opensmile.FeatureSet.emobase and feature_level == opensmile.FeatureLevel.Functionals:
            feature_size = 988
        elif (
            feature_set == opensmile.FeatureSet.emobase and feature_level == opensmile.FeatureLevel.LowLevelDescriptors
        ):
            feature_size = 26
        else:
            raise ValueError(f"unknown feature_set: {feature_set}/{feature_level}")
